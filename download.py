...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-u", "--user", action="store", dest="username", help="username for blackboard"
    )
    parser.add_argument(
        "-p",
        "--password",
    ...
    parser.add_argument(
        ...
        action="store",
        dest="url",
        help="url for blackboard site with links",
    )
    parser.add_argument(
        "-e",
        "--extension",
        action="store",
        dest="extension",
        help="file extension of the given files",
    )
    parser.add_argument(
        "-v", "--version", action="version", version="Blackboard Downloader version 0.1"
    )
